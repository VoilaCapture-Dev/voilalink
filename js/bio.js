...
const themes = {
  ...
  rosegold: { bg: '#1a0810', surface: '#2a1018', card: '#3a1822', accent: '#ff4d6d', accent2: '#ff9eb5' },
  forest:   { bg: '#071a0c', surface: '#0d2e14', card: '#12401c', accent: '#16a34a', accent2: '#4ade80' },
  neon:     { bg: '#020d14', surface: '#05161e', card: '#08202c', accent: '#06b6d4', accent2: '#22d3ee' },
  sakura:   { bg: '#fce4ec', surface: '#ffffff', card: '#fce7ef', accent: '#db2777', accent2: '#f472b6', isLight: true },
  carbon:   { bg: '#111111', surface: '#1c1c1c', card: '#272727', accent: '#64748b', accent2: '#e2e8f0' },
