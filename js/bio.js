...
const themes = {
  ...
  rosegold: { bg: '#0f080a', surface: '#1a0f12', card: '#23151a', accent: '#fb7185', accent2: '#fda4af' },
  forest:   { bg: '#050f08', surface: '#0a1a0f', card: '#0f2315', accent: '#4ade80', accent2: '#86efac' },
  neon:     { bg: '#020608', surface: '#070e12', card: '#0c1820', accent: '#22d3ee', accent2: '#67e8f9' },
  sakura:   { bg: '#fdf2f5', surface: '#ffffff', card: '#fce7ef', accent: '#ec4899', accent2: '#f9a8d4', isLight: true },
  carbon:   { bg: '#0a0a0a', surface: '#141414', card: '#1e1e1e', accent: '#94a3b8', accent2: '#cbd5e1' },
